...
MASS	 _CNT	   12.0000  !Carbon in carbon-based nano particle
MASS	 _Aum      196.9660 !Gold atom
MASS     _Ce       139.9050 !Cerium atom
MASS     _Si       28.08550 !Silicon
MASS     _Al       26.98000 !Aluminum
MASS     _Na       22.99000 !Sodium
END
!======================================================================
...
GROUP
 ATOM CA   TYPE=CA1 CHARge=0.000  END
GROUP
 ATOM CB   TYPE=CA2P CHARge=0.000  END
GROUP
...
GROUP
 ATOM CE   TYPE=CA2  CHARge=0.127  END
...
! ATOM CZ   TYPE=CRNP CHARge=0.340  END
 ATOM CZ   TYPE=CA   CHARge=0.340  END
